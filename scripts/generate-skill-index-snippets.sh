...
while IFS= read -r skill_dir; do
  ...
  case "$skill_dir" in
    ...
    ./skills/project-structure|./skills/local-tools|./skills/package-management|./skills/serialization|./skills/dotnet-devcert-*|./skills/opentelementry-*|./skills/ilspy-*|./skills/sdk-container-*|./skills/aot-*) dotnet+=("$name") ;;
